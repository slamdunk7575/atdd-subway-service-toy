...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void manageLineSection() {
        // when
        ExtractableResponse<Response> addResponse = 지하철_노선에_지하철역_등록_요청(신분당선, 강남역, 양재역, 5);
        // then
        ...
        // then
        지하철_노선에_지하철역_순서_정렬됨(findResponse1, Arrays.asList(강남역, 양재역, 광교역));
        ...
        // then
        지하철_노선에_지하철역_순서_정렬됨(findResponse2, Arrays.asList(강남역, 광교역));
    }
    ...
    @DisplayName("지하철 노선에 여러 구간을 순서 상관 없이 등록한다.")
    @Test
    ...
    @DisplayName("지하철 노선에 이미 등록된 구간을 등록한다.")
    @Test
    void addLineSectionAllSameStation() {
        // when
    ...
    @Test
    void addLineSectionNotExistStation() {
        // when
